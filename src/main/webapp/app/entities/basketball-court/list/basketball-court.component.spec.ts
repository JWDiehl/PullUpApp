...
import { sampleWithRequiredData } from '../basketball-court.test-samples';
...
describe('BasketballCourt Management Component', () => {
  let comp: BasketballCourtComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [BasketballCourtComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(BasketballCourtComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.basketballCourts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to basketballCourtService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBasketballCourtIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBasketballCourtIdentifier).toHaveBeenCalledWith(entity);
