...
let listAllCourts = fetch('http://localhost:8080/api/court-types', {
  headers: {Authorization: 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTcyNDU4NjAxNywiYXV0aCI6IlJPTEVfQURNSU4gUk9MRV9VU0VSIiwiaWF0IjoxNzI0NDk5NjE3fQ.WD_POivwgsjkbUZYWRbFuWgDxS-GPuNREbiFWSC867r2qhQpr4n4Xp_ztn4DnUhd94eBfIErEzY8J0bMIanboA'}
})
   .then(resp => resp.json())
